    ...
    <div className="pricing-container">
      ...
      <div className="pricing-cards-container">
        ...
        <div className="pricing-card business">
          <h3>Business</h3>
          <p className="price">€1500 <span>/mes</span></p>
